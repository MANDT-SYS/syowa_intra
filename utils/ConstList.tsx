export const ConstList = {
  ...
  AUTH_DOMAIN: 'https://m-and-t.jp.auth0.com', // Auth0 認証エンドポイント
  CLIENT_ID: 'AhAZrgvr70S0tVGIhq7xVxLvaN7JzZRV',  // Auth0で発行されたクライアントID

  DATABASE_NAME: 'intra-syowa', // データベース名（Auth0接続用）
